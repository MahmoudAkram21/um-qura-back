...
export declare const StarScalarFieldEnum: {
    readonly id: "id";
    ...
    readonly agriculturalInfo: "agriculturalInfo";
    readonly tips: "tips";
    readonly createdAt: "createdAt";
    readonly updatedAt: "updatedAt";
};
...
export declare const StarOrderByRelevanceFieldEnum: {
    readonly name: "name";
    readonly description: "description";
    readonly weatherInfo: "weatherInfo";
};
